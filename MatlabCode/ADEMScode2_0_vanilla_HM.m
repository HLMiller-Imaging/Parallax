function [SpotsCh1, SpotsCh2, frame_average,p, meta_data, image_data,firstLeft,firstRight] = ADEMScode2_0_vanilla_HM(fileName,p)
...
if p.useBioFormats==1
    ...
    meta_data='sorry metadata not available in this mode';
                ...
                image_data=fileName;
        numFrames=size(image_data,3);
        meta_data='sorry metadata not available in this mode'; %HM put this here
    end
end
