function [SpotsCh1,SpotsCh2,topsmatched,bottomsmatched,xyzPoints ,SpotsTrajtop,SpotsTrajbottom,fl_stack,bf_stack]=Track3D(filename,linkcons,n,pixsize,corr_coeff,p,use_calib,rampcalibdata,symcalibdata,calibmap,tolfactor,minCorr)
% TRACK3D
% Opens .tiff files and tracks them using ADEMS code, then applies linking
% routines either with or without a calibration.
%
% INPUTS
...
%make bf stack assuming 5 bf images
bf_stack=image_data(:,:,1:5);
end