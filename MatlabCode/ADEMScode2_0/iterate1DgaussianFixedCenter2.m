function [sdx, sdy, Icent] = iterate1DgaussianFixedCenter2(image_data,Ibg_avg, Isp, x_centre, y_centre,subarray_halfwidth, ...
    guess_sigma_Fit, show_output)
